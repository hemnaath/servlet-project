...
%>
<%=meetingHallTransObj1.getroomNumber() %>
<%=meetingHallTransObj1.getCheckIn() %>
<%=meetingHallTransObj1.getCheckOut() %>
<%=meetingHallTransObj1.getCategory()%>
<%=meetingHallTransObj1.getLocation() %>
<%=price %>
